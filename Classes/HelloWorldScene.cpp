...
bool HelloWorld::init()
{
    ...
    CCSprite* m_grossini = CCSprite::create("Images/grossini.png");

    // position the sprite on the center of the screen
    m_grossini->setPosition(ccp(visibleSize.width/2 + origin.x, visibleSize.height/2 + origin.y));

    // add the sprite as a child to this layer
    this->addChild(m_grossini, 0);
    ...
    CCFiniteTimeAction* action = CCSequence::create(
        ...
        CCShow::create(),
        CCMoveBy::create(10, CCPointMake(100, 0)),
        NULL) ;
